...
describe ('Test of Stoa API Server', () =>
{
    ...
    it ('Test of the path /block_height', () =>
    {
        let uri = URI(host)
            .port(port)
    ...
    it ('Test of the path /validators', () =>
    {
        let uri = URI(host)
            .port(port)
    ...
    it ('Tests that sending a pre-image with get /validator and /validators', async () =>
    {
        ...
        response = await client.get (uri1.toString());
        assert.strictEqual(response.data.length, 1);
    ...
    describe ('Test of pending transactions', () =>
    {
        ...
        it ('Test of the path /transactions/pending/:address', () =>
        {
            let uri = URI(host)
                .port(port)
                .directory("transactions/pending")
