...
describe ('Test of Stoa API Server', () =>
{
    ...
    it ('Test of the path /wallet/transactions/pending/:address', async () =>
    {
        ...
        assert.strictEqual(response.data[0].tx_hash, '0x91de02460f7269' +
            '7f82c714aedb367eca757ea721e013f5c9627deeabcc2ef3234809428' +
            '922f1b04cde9520a9f312130ac9bea7bf264e7192eae1cd7ba9c3e26e');
