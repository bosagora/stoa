...
describe('Hash', () => {
    ...
    it('Test of reading and writing hex string', () => {
        ...
        let h = Hash.createFromString('0x5d7f6a7a30f7ff591c8649f61eb8a35d034824ed5cd252c2c6f10cdbd223671' +
    ...
    it('Test of utxo key, using makeUTXOKey', () => {
        let hash = makeUTXOKey(Hash.createFromString('0x5d7f6a7a30f7ff591c8649f61eb8a35d034824ed5cd252c2c6f10cdbd223671' +
