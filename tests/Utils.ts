...
export class TestStoa extends Stoa {
    constructor(
        ...
        super(testDBConfig, agora_endpoint, port, Number(port) + 1000, "127.0.0.1", 1609459200, testVoteraService, testCoinMarketService);
    }
    ...
    constructor(
        ...
        this.app.get('/votera-proposal/ID1234567890', (req: Request, res: Response) => {
            const response = {
                ...
                proposal_fee_tx_hash: '0x11c6b0395c8e1716978c41958eab84e869755c09f7131b3bbdc882a647cb3f2c46c450607c6da71d34d1eab28fbfdf14376b444ef46ed1d0a7d2237ab430ebf5',
                vote_fee: 100,
                fundingAmount: 100000,
                voting_start_height: 3,
                voting_end_height: 6,
                tx_hash_vote_fee: '0x8b6a2e1ecc3616ad63c73d606c4019407ebfd06a122519e7bd88d99af92d19d9621323d7c2e68593053a570522b6bc8575d1ee45a74ee38726f297a5ce08e33d',
                assessResult: {
                    average: 7,
                    nodeCount: 2,
                    completeness: 6,
